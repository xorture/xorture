...
* **[Facturino](https://github.com/xorture/Facturi_AI_Extractor)** | *python, sql, ai apis*
  an automated business solution that connects local scripts with ai to parse complex, unstructured invoices (pdf/jpg) and structure the data into relational databases and excel reports. **work in progress**
* **[reclame pe paine](https://github.com/xorture/reclame-pe-paine-website)** | *javascript es6, css3, html5*
  a production-ready, mobile-first commercial platform built for a marketing agency. implements intersection observer for performance and strict client-side validation for secure lead generation.
